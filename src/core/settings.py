...
_declare("NEWS_MODEL", str, None, "CLI model for Originals; unset, the default of the CLI called (llm_client.CLI_MODELS).")
_declare("REPLY_MODEL", str, None, "CLI model for Replies; unset, the default of the CLI called (llm_client.CLI_MODELS).")
_declare("PRIORITY_REPLY_MODEL", str, None, "CLI model for priority Replies; unset, the default of the CLI called (llm_client.CLI_MODELS).")
...
_declare("OPENCODE_FALLBACK_MODEL", str, "opencode/big-pickle", "Label of an Ollama fallback; blank means this default.")
