"""Autonomous AGENTIC self-improvement for @AIBossGPT.
...
def _build_agent_prompt() -> str:
    ...
    return f"""Tu es le STRATEGY AGENT autonome de @AIBossGPT — un bot X qui couvre IA + crypto + bourse en français principalement.
