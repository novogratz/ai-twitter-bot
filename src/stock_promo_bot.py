...
WSB_HEADERS = {"User-Agent": "Mozilla/5.0 AISpaceDecoder-bot/1.0"}
LOOKAHEAD_DAYS = 3
...
ANNOUNCE_PROMPT = """You are @AISpaceDecoder. You just found the hottest AI/Space stock on WallStreetBets: ${ticker} ({company}).
