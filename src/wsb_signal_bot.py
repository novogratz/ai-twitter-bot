...
and quote-tweets it with a punchy @AIBossGPT take.
"""
import json
import os
import re
...
WSB_HEADERS = {
    "User-Agent": "Mozilla/5.0 AIBossGPT-bot/1.0",
}

QUOTE_PROMPT = """\
You are @AIBossGPT — The AI Boss. You just saw this tweet about ${ticker}:
...
def safe_run_wsb_signal_cycle() -> None:
    # DISABLED 2026-06-18 (AI Big Boss): WSB/stocks signals are off-brand for a
