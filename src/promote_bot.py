...
Strategy:
  - Once every ~3h. Visit /TheAIShrink/with_replies, scrape recent replies +
    their like counts.
  - Filter: must be authored by @TheAIShrink, must have ≥ MIN_LIKES.
...
def run_promote_cycle():
    ...
    # can pass "TheAIShrink/with_replies" to land on the right page.
