...
Strategy:
  - Once every ~3h. Visit /AIAlphaDecode/with_replies, scrape recent replies +
    their like counts.
  - Filter: must be authored by @AIAlphaDecode, must have ≥ MIN_LIKES.
...
def run_promote_cycle():
    ...
    # can pass "AIAlphaDecode/with_replies" to land on the right page.
