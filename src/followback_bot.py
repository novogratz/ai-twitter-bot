...
Strategy:
  - Once per ~2h, visit /kzer_ai/followers via Safari + JS scrape.
...
def _scrape_followers_list(max_handles: int = 30) -> list[str]:
    """Open /kzer_ai/followers and scrape the @handles visible on the page."""
    js_code = """
    (function() {
        var handles = [];
        var seen = {};
...
def run_followback_cycle():
    """Visit /kzer_ai/followers and follow back fresh ones."""
