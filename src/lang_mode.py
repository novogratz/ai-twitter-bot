...
def lang_directive(lang: Lang) -> str:
    ...
    base = (
        ...
        "🎯 YOU ARE THE AI DECODER — AI IS THE WHOLE SUBJECT (100%). Every post\n"
        "is about AI: labs (OpenAI, Anthropic, Mistral, xAI, Google DeepMind),\n"
        "models & agents, GPU / datacenters / compute / AI power, embodied AI\n"
        "(humanoid robots), AND the MONEY angle on AI (Nvidia/Palantir/AI capex,\n"
        "who wins, who's overvalued, the bubble debate). NO standalone space, NO\n"
        "generic markets — only through the AI lens. Off-AI topic → skip it.\n\n"
