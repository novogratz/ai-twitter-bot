...
ALLOWED_PATHS = {
    "caps.MAX_NEWS_PER_DAY":      (5, 80),
    "caps.MAX_HOTAKES_PER_DAY":   (2, 30),
    "caps.MAX_BREAKOUTS_PER_DAY": (0, 20),
    "caps.MAX_SPICY_PER_DAY":     (0, 20),
    "caps.MAX_QUOTES_PER_DAY":    (40, 500),
    "caps.MAX_RETWEETS_PER_DAY":  (100, 1200),
    "caps.MAX_REPLIES_PER_CYCLE": (10, 80),
...
PROPOSE_PROMPT = """You are the strategy optimizer for a French AI/crypto Twitter bot (@cryptoiadecode).
