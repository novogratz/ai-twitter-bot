...
Strategy:
  - Every 8 min, scrape /AIAlphaDecode for posts taking off (>= SPIKE_LIKES).
...
SPIKE_FOLLOWUP_PROMPT = """You are @AIAlphaDecode. One of your tweets is EXPLODING right now:
