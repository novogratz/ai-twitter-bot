...
/AIAlphaDecode every 30 min, parses the follower count from the profile
...
def _scrape_follower_count() -> int:
    """Open /AIAlphaDecode, JS-extract the number next to 'Followers' / 'Abonnés'."""
    js_code = '''
    (function() {
        // Followers link looks like /AIAlphaDecode/verified_followers or /followers.
