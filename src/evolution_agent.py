"""Autonomous EVOLUTION AGENT for @AIAlphaDecode — self-improvement of CONTENT quality.
...
def _build_prompt(stats: dict) -> str:
    return f"""Tu es l'EVOLUTION AGENT de @AIAlphaDecode (bot X IA+crypto+bourse FR).
