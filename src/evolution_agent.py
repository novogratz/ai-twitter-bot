"""Autonomous EVOLUTION AGENT for @cryptoiadecode — self-improvement of CONTENT quality.
...
def _build_prompt(stats: dict) -> str:
    return f"""Tu es l'EVOLUTION AGENT de @cryptoiadecode (bot X IA+crypto+bourse FR).
