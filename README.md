...
| **Amplification** | `retweet_bot`, `quote_tweet_bot`, `hot_quote_bot`, `feed_sweeper_bot` | QRT SURGE (≤100/day, 50-like floor) — number-reframe + metaphor + closing question on mid-size finance/AI posts; AI-vs-Bitcoin feud bit on BTC parents; plain RTs 0-2/day |
