...
| **Amplification** | `retweet_bot`, `quote_tweet_bot`, `hot_quote_bot`, `feed_sweeper_bot`, `boost_recycler_bot` | QRT quality lane (≤40/day, 50-like floor, screenshot-worthy or SKIP) — number-reframe + metaphor + closing question on mid-size finance/AI posts; AI-vs-Bitcoin feud bit; own winners recycled via un-RT→re-RT (4h gaps, max 4); plain RTs 0-2/day |
