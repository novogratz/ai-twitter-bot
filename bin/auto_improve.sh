...
4. SHIP VIA PR (operator mandate — PR flow, never direct push to main here):
   ...
   b. Commit ONLY your improvement files (update AGENTS.md, +README if user-facing, same commit). Do NOT commit unrelated dirty bot-state .json files — the running bot syncs those on main.
