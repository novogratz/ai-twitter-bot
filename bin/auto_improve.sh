...
Hard limits: never touch the Operator's files (the Voice, accounts/*/voice_*.md,
accounts/*/whitelist.json, accounts/*/respect_list.json), BLOCKLIST,
hard_rules_block(), or the zero-repost rule.
