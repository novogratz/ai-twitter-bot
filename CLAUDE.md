...
- **Qualité élite**: ~12 posts/jour (8 news + 4 hot takes). Chaque post doit être un banger
...
**Post bot** - News IA/crypto/finance en français (Opus, avec web search) + hot takes (Sonnet, sans web search). ~8 news + ~4 hot takes par jour. Qualité > quantité. Threads pour les grosses stories.
...
- **`src/bot.py`** - Post orchestration. ~67% news, ~33% hot takes. Persistent daily limits (8 news, 4 hot takes). Falls back to hot take when no news. Handles threads. Engagement logging.
...
| 6am - 10am   | 50-80 min     | 5 min          |
| 10am - 7pm   | 45-75 min     | 5 min          |
| 7pm - 11pm   | 60-90 min     | 5 min          |
...
- ~8 news + ~4 hot takes par jour. Qualité élite, pas de spam.
- TROLL MODE: le plus tranchant, le plus drôle, le plus provocateur.
